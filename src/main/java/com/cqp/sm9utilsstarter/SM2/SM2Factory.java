package com.cqp.sm9utilsstarter.SM2;
...
//		this.ecc_curve = new ECCurve.Fp(p, a, b);
	    ...
	    this.ecc_curve = new ECCurve.Fp(p, a, b);
		ecc_point_g= ecc_curve.createPoint(this.ecc_gx_fieldelement.toBigInteger(), this.ecc_gy_fieldelement.toBigInteger());
		ecc_point_g.getEncoded(true);

//		this.ecc_point_g = ecc_curve.createPoint(this.ecc_gx_fieldelement, this.ecc_gy_fieldelement);
